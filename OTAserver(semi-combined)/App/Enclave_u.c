...
static sgx_status_t SGX_CDECL Enclave_ocall_get_epid_group_id(void* pms)
{
	ms_ocall_get_epid_group_id_t* ms = SGX_CAST(ms_ocall_get_epid_group_id_t*, pms);
	ms->ms_retval = ocall_get_epid_group_id(ms->ms_extended_epid_group_id);
...
static const struct {
	...
	25,
	{
		...
		(void*)Enclave_ocall_get_epid_group_id,
