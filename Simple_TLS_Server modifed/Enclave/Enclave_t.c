...
typedef struct ms_ocall_readCertFile_t {
	char* ms_retval;
	char* ms_file;
} ms_ocall_readCertFile_t;

typedef struct ms_ocall_readKeyFile_t {
	char* ms_retval;
	char* ms_file;
} ms_ocall_readKeyFile_t;
...
sgx_status_t SGX_CDECL ocall_readCertFile(char** retval, const char* file)
{
	sgx_status_t status = SGX_SUCCESS;

	ms_ocall_readCertFile_t* ms = NULL;
	size_t ocalloc_size = sizeof(ms_ocall_readCertFile_t);
	void *__tmp = NULL;
	...
	ms = (ms_ocall_readCertFile_t*)__tmp;
	__tmp = (void *)((size_t)__tmp + sizeof(ms_ocall_readCertFile_t));
...
sgx_status_t SGX_CDECL ocall_readKeyFile(char** retval, const char* file)
{
	sgx_status_t status = SGX_SUCCESS;

	ms_ocall_readKeyFile_t* ms = NULL;
	size_t ocalloc_size = sizeof(ms_ocall_readKeyFile_t);
	void *__tmp = NULL;
	...
	ms = (ms_ocall_readKeyFile_t*)__tmp;
	__tmp = (void *)((size_t)__tmp + sizeof(ms_ocall_readKeyFile_t));
